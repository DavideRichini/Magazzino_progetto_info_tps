...
public class Menu 
{
    ...
    /**
     * l'utente può selezionare un int corrispondente ad una delle voci del menu.
     * controllo se l'input è valido (compreso tra 0 e numeroVoci-1)
    ...
    /**
     * visualizza l'elenco delle voci del menu sulla videata
     */
